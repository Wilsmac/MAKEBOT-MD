...
const smsAvisoEG = () => { return `╰⊱💚⊱ *𝐸́𝑋𝐼𝑇𝑂* ⊱💚⊱╮\n\n` }

const smsRowner = () => { return `\`\`\`¡¡𝐸𝑆𝑇𝐸 𝐶𝑂𝑀𝐴𝑁𝐷𝑂 𝑆𝑂́𝐿𝑂 𝐸𝐿 𝑁𝑈́𝑀𝐸𝑅𝑂 𝐷𝐸𝐿 𝐵𝑂𝑇 𝑃𝑈𝐸𝐷𝐸 𝑈𝑆𝐴𝑅!!\`\`\`` }
...
const smsAdmin = () => { return `\`\`\`¡¡𝐸𝑆𝑇𝐸 𝐶𝑂𝑀𝐴𝑁𝐷𝑂 𝑆𝑂́𝐿𝑂 𝐸𝑆 𝑃𝐴𝑅𝐴 𝐴𝐷𝑀𝐼𝑁𝑆!!\`\`\`` }
const smsBotAdmin = () => { return `\`\`\`¡¡𝑁𝐸𝐶𝐸𝑆𝐼𝑇𝑂 𝑆𝐸𝑅 𝐴𝐷𝑀𝐼𝑁 𝑃𝐴𝑅𝐴 𝑄𝑈𝐸 𝑃𝑈𝐸𝐷𝐴𝑆 𝑈𝑆𝐴𝑅 𝐸𝑆𝑇𝐸 𝐶𝑂𝑀𝐴𝑁𝐷𝑂🥺!!\`\`\`` }
const smsUnreg = () => { return `\`\`\`¡¡𝑁𝐸𝐶𝐸𝑆𝐼𝑇𝐴𝑆 𝐸𝑆𝑇𝐴𝑅 𝑅𝐸𝐺𝐼𝑆𝑇𝑅𝐴𝐷𝑂(𝐴) 𝑃𝐴𝑅𝐴 𝑈𝑆𝐴𝑅 𝑀𝐼𝑆 𝐶𝑂𝑀𝐴𝑁𝐷𝑂𝑆, 𝐸𝑆𝐶𝑅𝐼𝐵𝐸 #verificar 𝑃𝐴𝑅𝐴 𝑅𝐸𝐺𝐼𝑆𝑇𝑅𝐴𝑅𝑇𝐸!!\`\`\`` }
const smsRestrict = () => { return `\`\`\`¡¡𝐸𝑆𝑇𝐸 𝐶𝑂𝑀𝐴𝑁𝐷𝑂 𝐸𝑆𝑇𝐴́ 𝑅𝐸𝑆𝑇𝑅𝐼𝑁𝐺𝐼𝐷𝑂 𝑃𝑂𝑅 𝑀𝐼 𝐶𝑅𝐸𝐴𝐷𝑂𝑅(𝐴)!!\`\`\`` }
...
const smsSdemote = () => { return '*@user 𝐻𝐴 𝑆𝐼𝐷𝑂 𝐷𝐸𝐺𝑅𝐴𝐷𝐴𝐷𝑂 𝐶𝑂𝑀𝑂 𝐴𝐷𝑀𝐼𝑁 𝐷𝐸𝐿 𝐺𝑅𝑈𝑃𝑂!!*'}
const smsSdesc = () => { return '*𝐶𝑂𝑁𝑂𝑍𝐶𝐴𝑁 𝐿𝐴 𝑁𝑈𝐸𝑉𝐴 𝐷𝐸𝑆𝐶𝑅𝐼𝑃𝐶𝐼 𝐷𝐸𝐿 𝐺𝑅𝑈𝑃𝑂:*\n\n@desc'}
const smsSsubject = () => { return '*𝑆𝐸 𝐻𝐴 𝐴𝐶𝑇𝑈𝐴𝐿𝐼𝑍𝐴𝐷𝑂 𝐸𝐿 𝑁𝑂𝑀𝐵𝑅𝐸 𝐷𝐸𝐿 𝐺𝑅𝑈𝑃𝑂!!*\n@subject'}
const smsSicon = () => { return '*𝑆𝐸 𝐻𝐴 𝐴𝐶𝑇𝑈𝐴𝐿𝐼𝑍𝐴𝐷𝑂 𝐿𝐴 𝐹𝑂𝑇𝑂 𝐷𝐸𝐿 𝐺𝑅𝑈𝑃𝑂!!*'}
const smsSrevoke = () => { return '*𝐶𝑂𝑁𝑂𝑍𝐶𝐴𝑁 𝐸𝐿 𝑁𝑈𝐸𝑉𝑂 𝐸𝑁𝐿𝐴𝐶𝐸 𝐷𝐸𝐿 𝐺𝑅𝑈𝑃𝑂!!*\n*@revoke*'}
...
const smsEstado2 = () => { return '𝑉𝐸𝑅𝑆𝐼𝑂𝑁'}
const smsEstado3 = () => { return '𝑈𝑆𝑈𝐴𝑅𝐼𝑂𝑆/𝐴𝑆'}
const smsEstado4 = () => { return '𝑅𝐸𝐺𝐼𝑆𝑇𝑅𝐴𝐷𝑂𝑆/𝐴𝑆'}
const smsEstado5 = () => { return '𝐶𝐻𝐴𝑇/𝑆 𝑃𝑅𝑂𝐻𝐼𝐵𝐼𝐷𝑂/𝑆'}
...
//info-infobot.js
const smsBT1 = () => { return '𝐶𝑅𝐸𝐴𝐷𝑂𝑅𝐴'}
const smsBT2 = () => { return '𝑉𝐸𝑅𝑆𝐼𝑂́𝑁'}
const smsBT3 = () => { return '𝑃𝑅𝐸𝐹𝐼𝐽𝑂'}
const smsBT4 = () => { return '𝐶𝐻𝐴𝑇𝑆 𝑃𝑅𝐼𝑉𝐴𝐷𝑂𝑆'}
const smsBT5 = () => { return '𝐶𝐻𝐴𝑇𝑆 𝐷𝐸 𝐺𝑅𝑈𝑃𝑂𝑆'}
const smsBT6 = () => { return '𝐶𝐻𝐴𝑇𝑆 𝑇𝑂𝑇𝐴𝐿'}
const smsBT7 = () => { return '𝐴𝐶𝑇𝐼𝑉𝐼𝐷𝐴𝐷'}
const smsBT8 = () => { return '𝑈𝑆𝑈𝐴𝑅𝐼𝑂𝑆'}
const smsBT9 = () => { return '𝑆𝑈𝐵 𝐵𝑂𝑇𝑆 𝐴𝐶𝑇𝐼𝑉𝑂𝑆'}
...
const smsContacto4 = () => { return 'Contacto Oficial de MakeBot 🌺'}
...
const smsMalused2 = () => { return `${lenguajeGB['smsAvisoMG']()}🐈 *𝐷𝐸𝐵𝐸 𝐷𝐸 𝑈𝑆𝐴𝑅 𝐸𝐿 𝐶𝑂𝑀𝐴𝑁𝐷𝑂 𝐶𝑂𝑀𝑂 𝐸𝑁 𝐸𝑆𝑇𝐸 𝐸𝐽𝐸𝑀𝑃𝐿𝑂:*\n`}
...
const smsVerify7 = () => { return `✅ *𝑉 𝐸 𝑅 𝐼 𝐹 𝐼 𝐶 𝐴 𝐶 𝐼 𝑂 𝑁* ✅`}
